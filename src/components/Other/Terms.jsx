export default function Terms(){
    return (
      <div>
        <div>Privacy Policy for Subadha</div>
        <div>
          At Subadha, accessible from https://subadha.netlify.app/, one of our
          main priorities is the privacy of our visitors. This Privacy Policy
          document contains types of information that is collected and recorded
          by Subadha and how we use it. If you have additional questions or
          ...
          Privacy Policy Generator. Log Files Subadha follows a standard
          ...
          Beacons Like any other website, Subadha uses "cookies". These cookies
          ...
          advertising partners of Subadha. Third-party ad servers or ad networks
          ...
          Subadha, which are sent directly to users' browser. They automatically
          ...
          visit. Note that Subadha has no access to or control over these
          cookies that are used by third-party advertisers. Third Party Privacy
          Policies Subadha's Privacy Policy does not apply to other advertisers
          ...
          their online activity. Subadha does not knowingly collect any Personal
          ...
          regards to the information that they shared and/or collect in Subadha.
          ...
          you hereby consent to our Privacy Policy and agree to its Terms and
          Conditions.
        </div>
      </div>
    );
