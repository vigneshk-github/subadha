  ...
  export default function Team() {
    return (
      ...
      >
        <div
          id="team"
          className="font-body flex flex-col items-center justify-center px-6 py-12 bg-gray-100 dark:bg-black text-gray-900 dark:text-white pb-16"
        >
          <h1 className="sm:text-6xl text-5xl font-bold mb-4 text-center">
