...
export default function Footer() {
  return (
    <>
      <footer
        className={`font-body text-white dark:bg-white dark:text-black text-lg font-bold footer bg-base-200 p-10 ${style.footer}`}
      >
        <nav>
      ...
      <footer
        className={`font-body footer dark:bg-white dark:text-black bg-base-200 text-base-content border-base-300 border-t px-10 py-4 ${style.footerBottom}`}
      >
          ...
          <div className="flex sm:flex-row flex-col sm:justify-center sm:flex-end sm:items-center sm:pr-10">
            <span>
              <Link
                ...
                target="_blank"
                className="flex sm:pr-10 items-center gap-2 hover:text-red-700 transition"
              >
                <EmailIcon /> Email
              </Link>
            </span>
            <span>
              <Link
                ...
                target="_blank"
                className="flex sm:pr-10 items-center gap-2 hover:text-blue-700 transition"
              >
            ...
            <span>
              <Link
                ...
                target="_blank"
                className="flex sm:pr-10 items-center gap-2 hover:text-green-500 transition"
              >
            ...
            <span>
              <Link
                ...
                target="_blank"
                className="flex sm:pr-10 items-center gap-2 hover:text-blue-500 transition"
              >
                <XIcon /> Twitter
              </Link>
            </span>
