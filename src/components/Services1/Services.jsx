...
export default function Services() {
  return (
    <main
      id="service"
      className="dark:bg-#101010 pt-30 mt-20 sm:py-12 px-4 mx-10 sm:px-6 sm:mt-[-80px]"
    >
      <h1 className="text-6xl text-center text-gray-900 dark:text-white my-12 font-extrabold  sm:text-7xl tracking-tight">
        Services
      </h1>
